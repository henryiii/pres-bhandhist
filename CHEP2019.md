...
* Designed by Hans Dembinski, inspired by ROOT and GSL, released in Boost 1.70
...
* Static storage options - no heap allocation!
* 57 lines of vectorized assembly
* Custom storages, alloctors, accumulators, and axes
